...
/*
 ...
 + Theme Application
 + ----------------------------------------------------------------------------------------------------------
 + - This File, Location	 : Root Directory => Theme => 2024_California_Beach_Blue_Animated => Theme.php
...
/*
 ...
 +
 +
 + [ ^ ] Theme: 2024 :: California :: Beach Blue Animated
 +
 +
 ============================================================================================================
*/

$_THIS_THEME_DIRECTORY					= "2024_California_Beach_Blue_Animated";
...
<CENTER><A HREF=\"?$_INTERNAL_APPLICATION_MODULE_MEMBER&#61;News&amp;$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION_HTR_RANDOM_STRING_GENERATION\"><IMG SRC=\"./Theme/$_THIS_THEME_DIRECTORY/$_THIS_THEME_IMAGE_DIRECTORY/Banner/Banner_1.png?$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION_IMAGE_RANDOM_STRING_GENERATION\" WIDTH=\"95%\" HEIGHT=\"300\" CLASS =\"ThemeBanner\" TITLE=\":: Open & Display :: The Application Module :: Latest News Articles ::\" ALT=\":: Open & Display The Application Module :: Latest News Articles ::\"></A>
...
$_GLOBAL_THEME_LAYOUT_4			= "
			...
			<VIDEO ID=\"background-video\" AUTOPLAY LOOP MUTED POSTER=\"./Theme/$_THIS_THEME_DIRECTORY/Video/Background/Background_1.mp4?$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION_VIDEO_RANDOM_STRING_GENERATION\">
  				<SOURCE SRC=\"./Theme/$_THIS_THEME_DIRECTORY/Video/Background/Background_1.mp4?$_GLOBAL_SYSTEM_SECURITY_CACHE_CIRCUMVENTION__RANDOM_STRING_GENERATION\">
			</VIDEO>
